...
void ic(real ***t ,real ***p ,real ***u ,real ***v ,real ***w ,real *ro_u,real *ro_w,real dx,real dy,real  dz,real uPertur, int iW,int iE,int jS,int jN,int kB,int kT,int bcW,int nx,int ny,int nz,real *x0,real *y0,real *z0, real *deltaTheta,real *deltaV,real thetaBar, real *rx, real *ry, real *rz,real g)
{
