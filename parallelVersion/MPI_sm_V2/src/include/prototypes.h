...
void pgf(real ***p3,real ***u,real ***v,real ***w,real ***t,real ***p1,real *ro_u,real *ro_w,real dx,real dy,real dz,int i1,int i2,int j1,int j2,int k1,int k2,real tstep,real g,real thetaBar, real cs2, int bcw, MPI_Comm sm_comm, MPI_Win *sm_win_u,MPI_Win *sm_win_v,MPI_Win *sm_win_w); 

void ic(real ***t ,real ***u, real ***v,real ***w ,real *ro_u,real *ro_w,real dx,real dy,real  dz, real deltaU, int i1,int i2,int j1,int j2,int k1,int k2,real *x0,real *y0,real *z0, real *deltaTheta,real *deltaV,real thetaBar, real *rx, real *ry, real *rz,real g);
...
void advection(real ***q2,real ***u,real ***v,real ***w, real ***q1, real ***uu,real ***vv, real ***ww,real dx,real dy,real dz,real dt,int i1,int i2,int j1,int j2,int k1,int k2,int nxdim,int nydim,int nzdim,real tstep, char advection_type, MPI_Comm sm_comm,MPI_Win *sm_win_t);
