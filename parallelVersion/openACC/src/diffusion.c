...
void diffusion(real ***u,real ***restrict uu,real dx2,real dy2,real dz2,int i1,int i2,int j1,int j2,int k1,int k2,real tstep,real Ku) 
{

    #pragma acc parallel loop  present(u,uu) collapse(3) vector_length(VEC_LEN) //num_gangs(100) 
    ...
    }  // end for and of of parallel region  //
