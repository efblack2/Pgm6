...
*/
    ...
    #pragma acc data pcopyin(t1[0:nzdim][0:nydim][0:nxdim]),\
                     ...
                     pcreate(v3[0:nzdim][0:nydim+1][0:nxdim]),\
                     ...
                     pcopyin(ro_w[0:nzdim+1])
    {
        ...
        for (int n=1; n<=nstep; ++n) {
            ...
            #pragma acc parallel present(u3,u1,v3,v1,w3,w1)
            {
            ...
            diffusion(u3,u1,dx*dx,dy*dy,dz*dz,i1,i2,j1,j2,k1,k2,tstep,ku);
            diffusion(v3,v1,dx*dx,dy*dy,dz*dz,i1,i2,j1,j2,k1,k2,tstep,kv);
            diffusion(w3,w1,dx*dx,dy*dy,dz*dz,i1,i2,j1,j2,k1,k2,tstep,kw);
            diffusion(t2,t1,dx*dx,dy*dy,dz*dz,i1,i2,j1,j2,k1,k2,dt   ,kt);
            #pragma acc wait
            ...
            if (n == 1) {
                tstep=2.0*dt;
                update ((real ****) &p3, (real ****)&p2);
                update ((real ****) &u3, (real ****)&u2);
                update ((real ****) &v3, (real ****)&v2);
                update ((real ****) &w3, (real ****)&w2);
            } else {
                update ((real ****) &p2, (real ****)&p1);
                update ((real ****) &p3, (real ****)&p2);

                update ((real ****) &u2, (real ****)&u1);
                update ((real ****) &u3, (real ****)&u2);

                update ((real ****) &v2, (real ****)&v1);
                update ((real ****) &v3, (real ****)&v2);

                update ((real ****) &w2, (real ****)&w1);
                update ((real ****) &w3, (real ****)&w2);

            } // end if //
            update ((real ****) &t2, (real ****)&t1);
